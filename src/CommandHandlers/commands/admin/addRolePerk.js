...
module.exports = new CommandInterface({
	...
	execute: async function() {
		...
		await userDm.createMessage(`Your role perks have been extended by **${months} months**\nYou can change your role by typing \`snail changerole {hexcode} {roleName}\` on the **OwO Bot Support** server`);
		await this.reply(`, increased role benefits by **${months} months** for **${mention.username}#${mention.discriminator}**`);
	}
